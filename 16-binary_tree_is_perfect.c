 ...
 * and all leaves at the same depth or level.
 * This function assesses the symmetry in
 * terms of the number of levels on both
 * the left and right sides of each node,
 * as well as ensuring that each node has either
 ...
 * all levels have the maximum number of nodes.
 * @tree: Pointer to the root
 * node of the tree to check for perfection.
 * Return: 1 if the tree is perfect,
 * 0 if not or if tree is NULL.
 */
